...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/portPlus", "/","/portPlus/{imagem}","/portPlus/test").permitAll()
				.antMatchers("/perfil").hasRole("ALUNO")
				.antMatchers("/portPlus/criarCurso", "/perfil", "/portPlus/meusCursos").hasRole("INSTRUTOR")
